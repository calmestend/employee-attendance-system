                            ...
                            <table
                                ...
                                <thead>
                                    <tr class="bg-violet-100 dark:bg-gray-700 rounded-t-md shadow-sm">
                                        ...
                                        <th
                                            class="px-4 py-2 border-violet-200 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-r-md shadow-sm text-left">
                                            End Time
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr class="hover:bg-violet-50 dark:hover:bg-gray-600">
                                        ...
                                        <td
                                            class="px-4 py-2 border-violet-200 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-r-md shadow-sm">
                                            {{ $schedule->end_time }}
                                        </td>
                                    </tr>
                                    @endforeach
